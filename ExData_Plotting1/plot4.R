...
## Plotting multiple panels in one plot
par(mfrow = c(2,2))
hist(d1$Global_active_power,  main = "", xlab = "Global Active Power (kilowatts)", col ="red")
plot(d1$Date, d1$Voltage, xlab = "datetime", ylab = "Voltage", type = "l")
...
with(d1, plot(Date, Global_reactive_power, xlab = "datetime", ylab = "Global reactive power", type = "l"))
dev.off()
